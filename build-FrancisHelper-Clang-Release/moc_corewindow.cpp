/****************************************************************************
** Meta object code from reading C++ file 'corewindow.h'
**
...
#include "../FrancisHelper/corewindow.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'corewindow.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CoreWindow_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CoreWindow_t qt_meta_stringdata_CoreWindow = {
    {
QT_MOC_LITERAL(0, 0, 10), // "CoreWindow"
QT_MOC_LITERAL(1, 11, 16), // "handleMainButton"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "CoreWindow\0handleMainButton\0"
};
...
void CoreWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->handleMainButton(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject CoreWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CoreWindow.data,
      qt_meta_data_CoreWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CoreWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CoreWindow.stringdata))
